...
function updatePropertiesForCurrentSelection() {
	...
	if (showingIndex || showingSequences) {
		...
		if (add) {
			propertyEditors.lineColor.setEnabled(actionId=='addCircleAction' || actionId=='addLineAction' || actionId=='addCurveAction' || actionId=='placeAction' || actionId=='addFrameAction');
			propertyEditors.fillColor.setEnabled(actionId=='addCircleAction' || actionId=='addLineAction' || actionId=='placeAction' || actionId=='addFrameAction');
			propertyEditors.frameStyle.setEnabled(actionId=='addCircleAction' || actionId=='addLineAction' || actionId=='placeAction' || actionId=='addFrameAction');
			propertyEditors.textColor.setEnabled(actionId=='addCircleAction' || actionId=='addTextAction' || actionId=='placeAction' || actionId=='addFrameAction');
			propertyEditors.lineWidth.setEnabled(actionId=='addCircleAction' || actionId=='addLineAction' || actionId=='addCurveAction' || actionId=='placeAction' || actionId=='addFrameAction');
			propertyEditors.textSize.setEnabled(actionId=='addCircleAction' || actionId=='addTextAction' || actionId=='placeAction' || actionId=='addFrameAction');
			propertyEditors.text.setEnabled(actionId=='addCircleAction' || actionId=='addFrameAction' || actionId=='addTextAction');
			propertyEditors.showLabel.setEnabled(actionId=='addCircleAction' || actionId=='placeAction' || actionId=='addFrameAction');
			propertyEditors.textVAlign.setEnabled(actionId=='addCircleAction' || actionId=='addTextAction' || actionId=='placeAction' || actionId=='addFrameAction');
...
function getNewTool(project, view) {
	...
	if (project==objectOverviewProject || project==objectDetailProject) {
		if ($('#orderToBackAction').hasClass('actionSelected')) {
			...
			if (currentSketch && currentSketch.id)
				return new CircleTool(project, sketchbook, currentSketch.id, takeOrphanText());
		}
...
function registerMouseEvents() {
	...
	$(document).keydown(function(ev) {
		...
		if (ev.target.tagName && (ev.target.tagName=='TEXTAREA' || ev.target.tagName=='INPUT')) {
			...
			else if (ev.which=='J'.charCodeAt(0))
...
function showEditor(sketchId, noBreadcrumb, elementId) {
	...
	$('#addCirleAction').removeClass('actionDisabled');
